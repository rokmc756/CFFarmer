...
# --vars-store ./cf-deployment/iaas-support/vsphere/cloud-config-vars.yml \
#bosh -n -e bosh-1 -d cf delete-deployment ./cf-deployment/cf-deployment.yml \
#-v system_domain="$SYSTEM_DOMAIN" \
#-v cf_admin_password=admin \
#-v uaa_admin_client_secret="$BOSH_CLIENT_SECRET"


# bosh -e bosh-1 -d cf delete-deployment --force
bosh -n -e bosh-1 -d cf delete-deployment --force
bosh -n -e bosh-1 clean-up --all

# For VMware
# bosh -e bosh-1 delete-env /data/gen-vmware_micro_boshinit.yml
